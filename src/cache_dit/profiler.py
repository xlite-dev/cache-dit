...
class ProfilerContext:
  ...
  It centralizes trace-file naming, optional CUDA memory-history capture, and multi-rank output
  layout so profiling can be enabled consistently from scripts or helper decorators.
  """
  ...
  def __init__(
    ...
    assert (current_platform.is_accelerator_available() and current_platform.device_type
            == "cuda"), "Torch ProfilerContext currently only supports CUDA devices."
