...
`ContextParallelModelPlan` that describes which tensors should be sharded before a module runs and
which tensors should be gathered again before returning to the caller.
"""
