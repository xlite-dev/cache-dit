  ...
  def parallelize_tiling(
    ...
    def new_tiled_encode(
      ...
      **kwargs,
      ...
      tile_latent_stride_height = (self.tile_sample_stride_height //
    ...
    def new_tiled_decode(
      ...
      **kwargs,
      ...
      if self.config.patch_size is not None:
        ...
        blend_height = (self.tile_sample_min_height // self.config.patch_size -
                        tile_sample_stride_height)
        blend_width = (self.tile_sample_min_width // self.config.patch_size -
