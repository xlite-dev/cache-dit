    ...
    **kwargs,
    ...
    _cp_plan = {
      ...
      "visual_transformer_blocks.0": {
        "visual_embed": ContextParallelInput(split_dim=1, expected_dims=3, split_output=False),
      },
      ...
      "visual_transformer_blocks.*": {
        "text_embed": ContextParallelInput(split_dim=1, expected_dims=3, split_output=False),
