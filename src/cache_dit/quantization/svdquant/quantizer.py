...
class _ActivationSpanAccumulator:
    ...
    The accumulator keeps calibration memory bounded by reducing each observed batch
    to a single `[in_features]` span vector and periodically merging buffered spans
    on CPU.
    """
